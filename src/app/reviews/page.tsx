...
export const metadata: Metadata = {
  title: "Leave a Review | Hollywood Massage Therapies",
  description: "Leave Hollywood Massage Therapies a review on Google or Yelp.",
};

const reviews = [
  { label: "Leave a Google Review", href: "https://g.page/r/CbHMAviW3kqlEAE/review", kind: "google" },
  { label: "Leave a Yelp Review", href: "https://www.yelp.com/biz/hollywood-massage-therapies-hollywood", kind: "yelp" },
];
    ...
    <section className="bg-white py-20 md:py-28">
      <div className="mx-auto max-w-2xl px-4 text-center">
        ...
        <p className="mb-10 text-gray-600">
          Your feedback helps others find Hollywood Massage Therapies and helps us keep improving.
        </p>
